...
caps = [(f"./TrafficClearanceCalculator/lane{1}.webm"),(f"./TrafficClearanceCalculator/lane{2}.mp4"),(f"./TrafficClearanceCalculator/lane{3}.mp4"),(f"./TrafficClearanceCalculator/lane{4}.webm") ]
...
async def main():
    ...
    for func in functions:
        try:
            ...
            asyncio.wait_for(func, timeout=40)
