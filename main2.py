...
caps = ["lane1.mp4", "TrafficClearanceCalculator\lane1.webm", "TrafficClearanceCalculator\lane2.mp4", "lane4.mp4"]
...
def getRegionPoints(x1, y1):
    ...
    return [ 
        [(0,div_y1), (x1, div_y1), (x1, div_y1 + part_height), (0, div_y1 + part_height)],
        [(0,div_y1 + part_height), (x1, div_y1 + part_height), (x1, div_y1 + 2 * part_height),(0, div_y1 + 2 * part_height)],
        [(0, div_y1 + 2 * part_height), (x1, div_y1 + 2 * part_height), (x1, y1), (0, y1)]
    ]
...
classes_to_count = [2,3, 5, 7]  # car,motorcycle,truck,bus
        ...
        while True:
            ...
            if f:
               for index, counter in enumerate(counters):
                    ...
                    f = False
            cv2.putText(frame, (f"Calculated time for Road {i} is :{timer if timer<=27 else 27}"), (20, 70), font, 1, (255, 255, 0), 2)
